      ...
      <div className="rules__container">
        ...
        <div className="rules__explanation">
          ...
          <ul className="rules__general_list rules__kd_list">
            ...
            <li>2.1.2 Insults, toxic behavior, and racism are prohibited.</li>
            <li>2.1.3 Help not a teammate</li>
            <li>
              2.1.4 It is forbidden to place loot in other players' bases.
            </li>
            <li>
              2.1.5 Cheats, macros, and any software that gives an advantage are
              prohibited.
            </li>
            <li>2.1.6 It is prohibited to advertise third-party servers.</li>
            <li>2.1.7 It is forbidden to impersonate the administration.</li>
            <li>
            ...
            <li>
              2.1.10 The administration reserves the right to perform additional
              wipes in the event of serious bugs or balance violations.
            </li>
            <li>
              2.1.11 Suspicious players may be checked by the administration –
              admins may request a screenshot or game recording.
            </li>
            <li>2.1.12 Players are allowed to sell items in their stores</li>
            <li>
              2.1.13 Players can exchange resources through a vending machine
            </li>
          </ul>
          ...
          <ul className="rules__solo_list rules__kd_list">
            <li>2.2.1 It is forbidden to unite in groups, even temporarily.</li>
            <li>
            ...
            <li>
              2.2.6 It is forbidden to camp monuments together and help someone
              in PvP.
            </li>
            <li>
              2.2.7 Players caught in a team game will receive a ban or account
              wipe.
            </li>
          </ul>
          <p className="rules__solo_title rules__kd_title">
          ...
          <ul className="rules__duo_list rules__kd_list">
            ...
            <li>2.3.2 It is forbidden to unite with other players or clans.</li>
            <li>
              2.3.3 It is forbidden to transfer resources or help other teams.
            </li>
            <li>
              2.3.4 If your partner has left the game, you cannot temporarily
          ...
          <ul className="rules__trio_list rules__kd_list">
            ...
            <li>
              2.4.2 Temporary alliances between different trios are prohibited.
            </li>
            <li>
              2.4.3 If one of your team members leaves the game, you cannot add
            ...
            <li>
              2.4.6 Players who exceed the 3-person limit will be banned or have
              their account wiped.
            </li>
          </ul>
          <p className="rules__trio_title rules__kd_title">
          ...
          <ul className="rules__squad_list rules__kd_list">
            ...
            <li>
              2.5.4 If someone leaves the team, a new member can only join after
              a wipe or an official breakup.
            </li>
            <li>
            ...
            <li>
              2.5.7 If the team exceeds the player limit - ban or wipe of the
              account.
            </li>
          </ul>
        </div>
