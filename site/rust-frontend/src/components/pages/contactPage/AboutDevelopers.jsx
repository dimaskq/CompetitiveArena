...
const developers = [
    { id: 1, name: "Kravchenko Dmytro", role: "Fullstack Developer", img: dmytroIMG, delay: 2100 },
    { id: 2, name: "Serhiy Buhtiyarov", role: "Plugin Developer", img: dmytroIMG, delay: 2300 },
    { id: 3, name: "Ilarion Parkhomenko", role: "Social Media Manager", img: dmytroIMG, delay: 2500 }
];
