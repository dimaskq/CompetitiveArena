            ...
            <div className="about__container">
                    <div className="about__text_container">
                        ...
                        <div className="about__info_box">
                            <img src={img1} alt="image for first block of about" data-aos="fade-right" data-aos-delay="300"/>
                            <div className="about__list_container" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div className="about__info_box" >
                            ...
                            <img src={img2} alt="image for second block of about" data-aos="fade-left" data-aos-delay="500"/>
                        </div>
                    </div>
