      ...
      <div className="about__container">
        <div className="about__text_container">
          ...
          <div className="about__info_box">
            <img
              src={img1}
              alt="image for first block of about"
              data-aos="fade-right"
              data-aos-delay="300"
            />
            <div
            ...
            >
              ...
              <ul className="about__text_list">
                ...
                <li className="about__list_item">
                  Exciting Tournaments - Exciting tournaments for real
                  champions.{" "}
                </li>
                <li className="about__list_item">
                ...
                <li className="about__list_item">
                  Active Community - A friendly community of players ready to
                  communicate and play together.
                </li>
                <li className="about__list_item">
                  Player Support - Fast and responsive support to resolve any
                  issues.
                </li>
              </ul>
            </div>
          ...
          <div className="about__info_box">
            ...
            >
              ...
              <ul className="about__text_list">
                <li className="about__list_item">
                  Quality Servers – Powerful and stable servers for smooth
                  gaming experience.
                </li>
                <li className="about__list_item">
                  Regular Tournaments – Regular tournaments with exciting
                  competitions.
                </li>
                <li className="about__list_item">
                  Security and Fairness - Fair play and reliable protection from
                  violators.
                </li>
                <li className="about__list_item">
                  Strong Community – An active community of like-minded people
                  and players.
                </li>
                <li className="about__list_item">
                  Continuous Development – Constant updates and improvements for
                  a better experience.
                </li>
              </ul>
            </div>
            <img
              src={img2}
              alt="image for second block of about"
              data-aos="fade-left"
              data-aos-delay="500"
            />
          </div>
